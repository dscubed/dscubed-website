        ...
        <div className="flex flex-col gap-10 my-auto">
          <div className="flex flex-col gap-8 max-w-xl">
            ...
            <p className="text-xl text-text-secondary leading-relaxed">
              Interested in what we do? DSCubed is the club for data lovers,
              students passionate about tech, and those who want to learn more
              about data science. Follow to stay up to date on our latest
              events.
            </p>
          </div>
          <div className="grid grid-cols-5 gap-8 w-max">
            ...
            <Link
              href="https://www.linkedin.com/company/data-science-student-society/"
              target="_blank"
            >
