      ...
      <div className="grid grid-cols-[1fr,1fr] lg:grid-cols-1 gap-20 sm:gap-10">
        <div className="flex flex-col gap-10 my-auto max-w-xl lg:max-w-xl">
          <h2 className="text-6xl xl:text-5xl sm:text-4xl">
            <span className="block leading-tight xl:leading-snug">
              Become a
            </span>
            <span className="block leading-tight xl:leading-snug">
              Sponsor Today
          ...
          <p className="text-xl sm:text-lg leading-relaxed">
            Your invaluable support grants you exclusive access to the finest
            data science graduates, paving the way for your top-tier recruitment
            and innovation in the data-driven landscape.
          </p>
          <Link
            target="_blank"
