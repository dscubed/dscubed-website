      ...
      <div className="flex flex-col gap-10 max-w-screen-xl mx-auto">
        <div className="flex md:flex-col gap-4 md:gap-5 justify-between text-text-secondary">
          ...
          <div className="flex gap-8 md:mx-auto flex-wrap justify-center gap-y-6">
            ...
            <Link href="https://discord.gg/Q3gZcPQV63" target="_blank">
            ...
            <Link
              href="https://www.xiaohongshu.com/user/profile/6543cfc7000000000301f7d9?xhsshare=CopyLink&appuid=5c3186f0000000000603e555&apptime=1725321208&share_id=cece5619af7d46079489e7d4263ac3d9"
              target="_blank"
            >
              <svg
