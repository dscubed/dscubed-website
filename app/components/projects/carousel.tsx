...
const { src, button, title, description } = slide;
  ...
  return (
    <div className="[perspective:1200px] [transform-style:preserve-3d]">
      <li
        ref={slideRef}
        className="flex flex-1 flex-col items-center justify-center relative text-center text-white opacity-100 transition-all duration-300 ease-in-out w-[45vmin] h-[60vmin] mx-[4vmin] z-10 "
...
export default function Carousel({ slides }: CarouselProps) {
  ...
  return (
    ...
    >
      <ul
        className="absolute flex mx-[-4vmin] transition-transform duration-100 ease-in-out"
        style={{
