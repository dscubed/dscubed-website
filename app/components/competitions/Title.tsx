...
export default function Title() {
  ...
  useEffect(() => {
    ...
    const updateTimer = () => {
      ...
      if (now < competitionStart) {
        ...
        setTimerText(
          `Time Until Competition: ${days}d ${hours}h ${minutes}m ${seconds}s`,
        );
  ...
  return (
    <>
      <div className="w-screen h-[90vh] sm:h-[50vh] flex relative items-center justify-center">
        <Image
        ...
        <div className="absolute flex flex-col justify-center mx-20 sm:mx-5 text-white">
          <h2 className="sm:text-lg text-4xl font-semibold text-[#4ea6e9]">
            kaggle <span className="text-white">COMPETITION</span>
          </h2>

          <h1 className="sm:text-xl text-5xl font-extrabold mt-2 leading-tight">
            KICK GOALS WITH DATA:
            <br />
            PREDICT AFL LADDER POSITIONS
          </h1>

          <p className="mt-4 max-w-2xl text-lg sm:hidden">
            Join us for our flagship data competition! Whether youre a footy
            fanatic, a data science enthusiast, or just keen to try something
            new, this is the perfect chance to sharpen your skills, build your
            portfolio, and connect with a vibrant community. No prior experience
            needed – just bring your curiosity and team spirit!
          </p>
